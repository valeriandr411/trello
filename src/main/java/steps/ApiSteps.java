...
public class ApiSteps {
    ...
    /**
     * ћетод, позвол€ющий мент€ть состо€ние чек-бокса в карточке
     *
     * @param idCard      id карточки
     * @param idCheckItem id чек-бокса
     * @param state       состо€ние, в которое нужно перевести чек-бокс: complete, incomplete.
    ...
    /**
     * ћетод, позвол€ющий создавать карточки
    ...
    /**
     * ћетод, позвол€ющий удалить карточку
     * @param idCard id карточки
     */
    ...
    /**
     * ћетод, позвол€ющий добавить описание к карточке
     *
     * @param idCard
    ...
    /**
     * ћетод, позвол€ющий добавл€ть вложение в карточку
     * @param idCard id карточки
    ...
    /**
     * ћетод, позвол€ющий перемещать карточку в колонку
     * @param idCard id карточки
     * @param idList id колонки
     * @throws JSONException
     */
    ...
    /**
     * ћетод, позвол€ющий изменить дату выполнени€ в карточки.
     * ќтсчет ведетс€ от текущего дн€.
     * @param idCard id карточки
     * @param numberDays количество дней, на которое следует увеличить
     *                   или уменьшить (тогда передаетс€ со знаком минус) дату исполнени€ задачи
     * @throws JSONException
     */
...
//---------------------------------- ќЋќЌ »-------------------------------------------//
    ...
    /**
     * ћетод, создающий новую колонку дл€ заданной доски
     *
     * @param name    им€ колонки
